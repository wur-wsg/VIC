...
double calc_surf_energy_bal(double, double, double, double, double, double,
                            ...
                            double *, double *, double *, double *, double,
                            double *, double *, double,
                            double *, double *, int, int, size_t, size_t,
                            double, size_t, unsigned short int,
                            int, double *, double *, force_data_struct *,
...
double CalcSubFlux(double EactAir, double es, double Zrh, double AirDens,
                   ...
                   double Tair, double U10,
                   double Zo_salt, double F,
                   double *Transport);
...
double canopy_evap(layer_data_struct *, veg_var_struct *, veg_lib_struct *,
                   ...
                   double, double,
                   double *);
void colavg(double *, double *, double *, double, double *, int, double, double);
...
int newt_raph(void (*vecfunc)(double *, double *, int, int, ...), double *, int);
...
void prepare_full_energy(cell_data_struct *, energy_bal_struct *,
                         ...
                         double *);
double qromb(
    double (*sub_with_height)(), double es, double Wind, double AirDens,
    double ZO,
...
int snow_intercept(double, double, double, double, double, double, double,
                   ...
                   double *, double *, double *, double *, double *, double *,
                   double *, double *,
                   double *, double *, double *, bool *, unsigned int *,
                   double *, double *,
                   double *, double *, double *, double *, double *, int, int,
                   int, int, int,
                   double *, double *, force_data_struct *, layer_data_struct *,
                   soil_con_struct *,
                   veg_var_struct *,
                   veg_lib_struct *);
...
double solve_snow(char, double, double, double, double, double, double, double,
                  ...
                  double *, double *, double *, double *, double *, double *,
                  int, size_t,
                  unsigned short int, unsigned short int, double, size_t, int *,
                  double *,
                  double *, dmy_struct *, force_data_struct *,
                  energy_bal_struct *,
...
int surface_fluxes(bool, double, double, double, double, double *, double *,
                   ...
                   veg_var_struct *, veg_lib_struct *, double, double, double,
                   double *);
double svp(double);
...
double transport_with_height(double z, double es, double Wind, double AirDens,
                             ...
                             double Zrh);
double trapzd(
    double (*funcd)(), double es, double Wind, double AirDens, double ZO,
    double EactAir, double F, double hsalt, double phi_r, double ushear,
    double Zrh,
