...
void
copy_wofost_table(TABLE *from, TABLE *to)
{
    to->x = from->x;
    to->y = from->y;
    to->next = NULL;
...
void
copy_wofost_table_list(TABLE **from, TABLE **to)
{
...
void
copy_wofost_table_d(TABLE_D *from, TABLE_D *to)
{
...
void
copy_wofost_table_d_list(TABLE_D **from, TABLE_D **to)
{
...
void
copy_wofost_rates(Rates *from, Rates *to)
{
...
void
copy_wofost_states(States *from, States *to)
{
    to->EvapWater = from->EvapWater;
    to->EvapSoil = from->EvapSoil;
    to->Infiltration = from->Infiltration;
...
void
copy_wofost_constants(Constants *from, Constants *to)
{
...
void
copy_wofost_geen(Green *from, Green *to)
{
    to->age = from->age;
    to->area = from->area;
...
void
copy_wofost_green_list(Green **from, Green **to)
{
...
void
copy_wofost_growth_rates(growth_rates *from, growth_rates *to)
{
...
void
copy_wofost_dying_rates(dying_rates *from, dying_rates *to)
{
    to->leaves = from->leaves;
    to->roots = from->roots;
    to->stems = from->stems;
...
void
copy_wofost_dying_states(dying_states *from, dying_states *to)
{
    to->leaves = from->leaves;
    to->roots = from->roots;
    to->stems = from->stems;
...
void
copy_wofost_nutrient_rates(nutrient_rates *from, nutrient_rates *to)
{
    to->roots = from->roots;
    to->stems = from->stems;
    to->leaves = from->leaves;
...
void
copy_wofost_nutrient_states(nutrient_states *from, nutrient_states *to)
{
    to->roots = from->roots;
    to->stems = from->stems;
    to->leaves = from->leaves;
...
void
copy_wofost_parameters(Parameters *from, Parameters *to)
{
    ...
    copy_wofost_table_list(&from->FactorAssimRateTemp, &to->FactorAssimRateTemp);
    copy_wofost_table_list(&from->FactorGrossAssimTemp, &to->FactorGrossAssimTemp);
...
void
copy_wofost_plant(Plant *from, Plant *to)
{
...
void
copy_wofost_field(Field *from, Field *to)
{
...
void
copy_wofost_soil(Soil *from, Soil *to)
{
    ...
    copy_wofost_table_list(&from->HydraulicConductivity, &to->HydraulicConductivity);
    copy_wofost_table_list(&from->VolumetricSoilMoisture, &to->VolumetricSoilMoisture);
}
...
void
copy_wofost_management(Management *from, Management *to)
{
