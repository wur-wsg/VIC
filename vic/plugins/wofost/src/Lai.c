...
/* -----------------------------------------------------------------------*/
float LeaveAreaIndex(SimUnit *Grid)
{
    float LAISum = 0.;
    ...
    {
        LAISum += Grid->crp->LeaveProperties->weight * Grid->crp->LeaveProperties->area;
    ...
    return (LAISum + Grid->crp->st.stems * Afgen(Grid->crp->prm.SpecificStemArea, &(Grid->crp->st.Development)) +
