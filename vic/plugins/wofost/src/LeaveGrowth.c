...
void LeaveGrowth(SimUnit *Grid)
{
    ...
    SpecLeafArea = Afgen(Grid->crp->prm.SpecificLeaveArea, &(Grid->crp->st.Development)) * 
        exp(-Grid->crp->prm.NutrientStessSLA * (1.-Grid->crp->NPK_Indx));
