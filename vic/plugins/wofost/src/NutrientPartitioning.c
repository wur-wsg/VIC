...
{     
    ...
    Grid->crp->N_rt.Demand = Grid->crp->N_rt.Demand_lv + Grid->crp->N_rt.Demand_st + Grid->crp->N_rt.Demand_ro;
    Grid->crp->P_rt.Demand = Grid->crp->P_rt.Demand_lv + Grid->crp->P_rt.Demand_st + Grid->crp->P_rt.Demand_ro;
    Grid->crp->K_rt.Demand = Grid->crp->K_rt.Demand_lv + Grid->crp->K_rt.Demand_st + Grid->crp->K_rt.Demand_ro;
    ...
    {
        Grid->crp->N_rt.Uptake_lv = (Grid->crp->N_rt.Demand_lv / Grid->crp->N_rt.Demand) * (Grid->crp->N_rt.Uptake + N_Fix_rt);
        Grid->crp->N_rt.Uptake_st = (Grid->crp->N_rt.Demand_st / Grid->crp->N_rt.Demand) * (Grid->crp->N_rt.Uptake + N_Fix_rt);
        Grid->crp->N_rt.Uptake_ro = (Grid->crp->N_rt.Demand_ro / Grid->crp->N_rt.Demand) * (Grid->crp->N_rt.Uptake + N_Fix_rt);
    }
    else
    {
    ...
    {
        Grid->crp->P_rt.Uptake_lv = (Grid->crp->P_rt.Demand_lv / Grid->crp->P_rt.Demand) * Grid->crp->P_rt.Uptake;
        Grid->crp->P_rt.Uptake_st = (Grid->crp->P_rt.Demand_st / Grid->crp->P_rt.Demand) * Grid->crp->P_rt.Uptake;
        Grid->crp->P_rt.Uptake_ro = (Grid->crp->P_rt.Demand_ro / Grid->crp->P_rt.Demand) * Grid->crp->P_rt.Uptake; 
    }
    else
    {
   ...
   /* K uptake per crop organ kg ha-1 d-1*/
    ...
    {
        Grid->crp->K_rt.Uptake_lv = (Grid->crp->K_rt.Demand_lv / Grid->crp->K_rt.Demand) * Grid->crp->K_rt.Uptake;
        Grid->crp->K_rt.Uptake_st = (Grid->crp->K_rt.Demand_st / Grid->crp->K_rt.Demand) * Grid->crp->K_rt.Uptake;
        Grid->crp->K_rt.Uptake_ro = (Grid->crp->K_rt.Demand_ro / Grid->crp->K_rt.Demand) * Grid->crp->K_rt.Uptake;   
    }
    else
    {
