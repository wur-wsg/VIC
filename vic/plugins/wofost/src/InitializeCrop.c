...
int EmergenceCrop(SimUnit *Grid, int Emergence)
{
    float DeltaTempSum;
...
void InitializeCrop(SimUnit *Grid)
{ 
    float FractionRoots;
    ...
    Grid->crp->st.stems     = InitialShootWeight * Afgen(Grid->crp->prm.Stems, &(Grid->crp->st.Development));                   
    Grid->crp->st.leaves    = InitialShootWeight * Afgen(Grid->crp->prm.Leaves, &(Grid->crp->st.Development));
    ...
    Grid->crp->st.LAI = LAIEmergence + Grid->crp->st.stems * 
           Afgen(Grid->crp->prm.SpecificStemArea, &(Grid->crp->st.Development)) +
    ...
    Grid->crp->LeaveProperties->area   = Afgen(Grid->crp->prm.SpecificLeaveArea, &(Grid->crp->st.Development));
