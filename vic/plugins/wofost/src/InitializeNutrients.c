...
void InitializeNutrients(SimUnit *Grid)
{    
    ...
    Grid->ste->st_N_tot = List(Grid->mng->N_Fert_table) * Grid->mng->N_Uptake_frac;
    Grid->ste->st_P_tot = List(Grid->mng->P_Fert_table) * Grid->mng->P_Uptake_frac;
    Grid->ste->st_K_tot = List(Grid->mng->K_Fert_table) * Grid->mng->K_Uptake_frac;
