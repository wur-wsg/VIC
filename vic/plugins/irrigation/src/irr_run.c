                ...
                if(area_fract > 0){ 
                    ...
                    **********************************************************************/
                    ...
                    if (options.SHARE_LAYER_MOIST &&
                        ((total_moist >= total_wcr && lower_moist >= lower_wcr && total_wcr > 0.) ||
                         (total_moist >= total_wcr && (1 - lower_root) >= 0.5) ||
                        ...
                        for (k = 0; k < options.Nlayer; k++) {
                            ...
                            else if (moist[k] >= csoil_con->Wpwp[k] && moist[k] < ccell_var->layer[k].Wcr) {
                                ccell_var->layer[k].water_stress = (moist[k] - csoil_con->Wpwp[k]) / (ccell_var->layer[k].Wcr - csoil_con->Wpwp[k]);
                            }
                            else {
                    ...
                    for (k = 0; k < options.Nlayer; k++) {
                        ccell_var->water_stress += ccell_var->layer[k].water_stress * cveg_con->root[k];
                    }
                }
            }
        }
