...
check_init_state_file(void)
{
    ...
    if (mpi_rank == VIC_MPI_ROOT){
        ...
        get_nc_var_attr(&filenames.init_state, "time", "units", &nc_time_unit_char);
        
        get_nc_var_attr(&filenames.init_state, "time", "calendar", &nc_calendar_char);
        ...
        parse_nc_time_units(nc_time_unit_char, &init_time_unit, &time_origin_dmy);
        num2date(global_param.time_origin_num, nc_init_time, 0, nc_calendar,init_time_unit, &init_time_dmy);
        ...
        init_time_num = date2num(global_param.time_origin_num, &init_time_dmy,0, global_param.calendar, TIME_UNITS_DAYS);
        ...
        start_time = date2num(global_param.time_origin_num, &start_dmy, 0., global_param.calendar, TIME_UNITS_DAYS);
